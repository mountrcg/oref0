...
function defaults ( ) {
  return /* profile */ {
    ...
    , iob_threshold_percent: 1 //Default value: 100%. This is the share of maxIOB above which the Full Loop will disable SMB. With 100% this feature is effectively disabled. Relative level of maxIOB above which SMBs are disabled. Will be between 0..1 from Tai.
