...
{   // interpolate ISF behaviour based on polygons defining nonlinear functions defined by value pairs for ...
    //  ...    <---------------  glucose  ------------------->
    var polyX_bg = [  50,    54,    72,    90,   108,    126,   144,   162,   180,   207,   261,   280];    // later, hand it over
    var polyY_bg = [-0.47,  -0.47, -0.43, -0.36, -0.22,  0.0,  0.26,  0.49,   0.64,  0.75,  0.8,   0.8];    // later, hand it over
    //  ...       <-----  delta  ------->
